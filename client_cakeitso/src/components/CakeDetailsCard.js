...
export default function CakeDetailsCard({ cake }) {
  return (
    ...
    <div className="card-body">
      ...
      <a href="#" className="btn btn-primary">View Customer Info</a>
      <a href="#" className="btn btn-primary">View Event Details</a>
      <a href="#" className="btn btn-primary">Update Cake</a>
      <a href="#" className="btn btn-primary">Delete Cake</a>
    </div>
  </div>
</div>
  )
